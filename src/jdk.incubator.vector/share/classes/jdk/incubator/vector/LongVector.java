...
public abstract class LongVector extends AbstractVector<Long> {
   ...
   /**
    ...
    boolean compareWithOp(int cond, long a, long b) {
        ...
        case BT_ult: return Long.compareUnsigned(a, b) < 0;
        case BT_ule: return Long.compareUnsigned(a, b) <= 0;
        case BT_ugt: return Long.compareUnsigned(a, b) > 0;
        case BT_uge: return Long.compareUnsigned(a, b) >= 0;
        }
