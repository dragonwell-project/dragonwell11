...
public abstract class ShortVector extends AbstractVector<Short> {
   ...
   /**
    ...
    boolean compareWithOp(int cond, short a, short b) {
        ...
        case BT_ult: return Short.compareUnsigned(a, b) < 0;
        case BT_ule: return Short.compareUnsigned(a, b) <= 0;
        case BT_ugt: return Short.compareUnsigned(a, b) > 0;
        case BT_uge: return Short.compareUnsigned(a, b) >= 0;
        }
