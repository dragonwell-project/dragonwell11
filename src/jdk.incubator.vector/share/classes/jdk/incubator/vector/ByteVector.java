...
public abstract class ByteVector extends AbstractVector<Byte> {
   ...
   /**
    ...
    boolean compareWithOp(int cond, byte a, byte b) {
        ...
        case BT_ult: return Byte.compareUnsigned(a, b) < 0;
        case BT_ule: return Byte.compareUnsigned(a, b) <= 0;
        case BT_ugt: return Byte.compareUnsigned(a, b) > 0;
        case BT_uge: return Byte.compareUnsigned(a, b) >= 0;
        }
