...
public:
  ...
  static bool matcher_find_shared_post_visit(Matcher* matcher, Node* n, uint opcode);
  static bool needs_anti_dependence_check(const Node* node);
  ...
  static void barrier_insertion_phase(Compile* C, PhaseIterGVN &igvn);
