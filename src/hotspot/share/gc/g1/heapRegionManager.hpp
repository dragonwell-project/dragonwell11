...
class HeapRegionChunkClaimer {
  ...
  uint _n_regions;
  uint _n_chunks;
  volatile jbyte* _claims;

  static const jbyte Unclaimed = 0;
  static const jbyte Claimed   = 0xff;
 ...
 public:
  static const uint ChunksPerRegion = (uint)(sizeof(RegionClaimState) / sizeof(jbyte));
  ...
  bool is_chunk_claimed(uint chunk_index) const {
    ...
    volatile jbyte* state = _claims + chunk_index;
