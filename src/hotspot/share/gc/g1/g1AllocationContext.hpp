...
public:
  ...
  inline AllocationContext_t& operator =(const AllocationContext_t& ctxt) {
    ...
    Atomic::store((G1TenantAllocationContext*)ctxt._value._tenant_alloc_context, &_value._tenant_alloc_context);
    return *this;
  }
  inline AllocationContext_t& operator =(const G1TenantAllocationContext* tac) {
    ...
    Atomic::store(const_cast<G1TenantAllocationContext*>(tac), &_value._tenant_alloc_context);
    return *this;
  }
