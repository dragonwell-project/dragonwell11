...
public:
  ...
  void vmovdqu(XMMRegister dst, AddressLiteral src, Register scratch_reg);
  // AVX512 Unaligned
  ...
  void evmovdqub(XMMRegister dst, KRegister mask, Address src, int vector_len) { Assembler::evmovdqub(dst, mask, src, vector_len); }
  ...
  void evmovdquw(Address dst, KRegister mask, XMMRegister src, int vector_len) { Assembler::evmovdquw(dst, mask, src, vector_len); }
  ...
  void evmovdquw(XMMRegister dst, KRegister mask, Address src, int vector_len) { Assembler::evmovdquw(dst, mask, src, vector_len); }
  ...
  void vxorpd(XMMRegister dst, XMMRegister nds, AddressLiteral src, int vector_len, Register scratch_reg);
  ...
  void vpxor(XMMRegister dst, XMMRegister nds, AddressLiteral src, int vector_len, Register scratch_reg);
