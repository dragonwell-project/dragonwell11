...
final class Int256Vector extends IntVector {
    ...
    public void intoArray(int[] a, int ix, int[] b, int iy) {
     ...
     public final void intoArray(int[] a, int ax, Mask<Integer> m, int[] b, int iy) {
         ...
         Int256Vector oldVal = SPECIES.fromArray(a, ax, b, iy);
         Int256Vector newVal = oldVal.blend(this, m);
    ...
    static final class Int256Species extends IntSpecies {
        ...
        @Override
        @ForceInline
        public Int256Mask maskFromArray(boolean[] bits, int ix) {
        ...
        @Override
        @ForceInline
        public Int256Vector fromArray(int[] a, int ax, Mask<Integer> m) {
        ...
        @Override
        @ForceInline
        public Int256Vector fromArray(int[] a, int ix, int[] b, int iy) {
            Objects.requireNonNull(a);
            Objects.requireNonNull(b);
            ...
            return VectorIntrinsics.loadWithMap(Int256Vector.class, int.class, LENGTH, Int256Vector.class,
                                        a, Unsafe.ARRAY_INT_BASE_OFFSET, vix,
                                        a, ix, b, iy,
       ...
       @Override
       @ForceInline
       public Int256Vector fromArray(int[] a, int ax, Mask<Integer> m, int[] indexMap, int j) {
           // @@@ This can result in out of bounds errors for unset mask lanes
        ...
        @Override
        @ForceInline
        public Int256Vector fromByteArray(byte[] a, int ix, Mask<Integer> m) {
        ...
        @Override
        @ForceInline
        public Int256Vector fromByteBuffer(ByteBuffer bb, int ix, Mask<Integer> m) {
        ...
        public <F> Int256Vector cast(Vector<F> o) {
            if (o.length() != LENGTH)
        ...
        @SuppressWarnings("unchecked")
        @ForceInline
        private <F> Int256Vector castDefault(Vector<F> v) {
        ...
        @ForceInline
        @SuppressWarnings("unchecked")
        public <F> Int256Vector rebracket(Vector<F> o) {
            Objects.requireNonNull(o);
        ...
        @ForceInline
        @SuppressWarnings("unchecked")
        public Int256Vector resize(Vector<Integer> o) {
            Objects.requireNonNull(o);
