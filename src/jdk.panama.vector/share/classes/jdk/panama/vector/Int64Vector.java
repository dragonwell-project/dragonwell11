...
final class Int64Vector extends IntVector {
    ...
    static final class Int64Species extends IntSpecies {
       ...
       public Int64Vector fromArray(int[] a, int ax, Mask<Integer> m, int[] indexMap, int j) {
        ...
        public <F> Int64Vector cast(Vector<F> o) {
            if (o.length() != LENGTH)
        ...
        @SuppressWarnings("unchecked")
        @ForceInline
        private <F> Int64Vector castDefault(Vector<F> v) {
        ...
        @ForceInline
        @SuppressWarnings("unchecked")
        public <F> Int64Vector rebracket(Vector<F> o) {
            Objects.requireNonNull(o);
        ...
        @ForceInline
        @SuppressWarnings("unchecked")
        public Int64Vector resize(Vector<Integer> o) {
            Objects.requireNonNull(o);
