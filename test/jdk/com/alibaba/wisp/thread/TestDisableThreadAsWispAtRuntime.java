 ...
 * @run main/othervm -XX:+EnableCoroutine -XX:+UseWispMonitor -Dcom.alibaba.wisp.transparentWispSwitch=true -Dcom.alibaba.wisp.version=2 TestDisableThreadAsWispAtRuntime
*/
...
public class TestDisableThreadAsWispAtRuntime {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int i = 0; i < 1000; i++) {
            ...
            switchShift(on);
            for (int j = 0; j < 50; j++) {
                assertEQ(on, es.submit(TestDisableThreadAsWispAtRuntime::inCoroutine).get());
            }
        }
