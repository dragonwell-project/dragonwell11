 ...
 * @run main/othervm   -XX:-UseBiasedLocking -XX:+EnableCoroutine -XX:+UseWispMonitor -Dcom.alibaba.wisp.transparentWispSwitch=true -Dcom.alibaba.globalPoller=false TestWispEngineCriticalSection
 */
...
public class TestWispEngineCriticalSection {
