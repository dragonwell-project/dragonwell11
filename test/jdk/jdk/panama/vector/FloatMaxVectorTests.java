...
public class FloatMaxVectorTests extends AbstractVectorTest {
   ...
   static final IntFunction<float[]> fr = (vl) -> {
    ...
    static void addAllFloatMaxVectorTests(IntFunction<float[]> fa) {
        ...
        assertReductionArraysEquals(a, r, FloatMaxVectorTests::addAll);
    }
    ...
    static void subAllFloatMaxVectorTests(IntFunction<float[]> fa) {
        ...
        assertReductionArraysEquals(a, r, FloatMaxVectorTests::subAll);
    }
    ...
    static void mulAllFloatMaxVectorTests(IntFunction<float[]> fa) {
        ...
        assertReductionArraysEquals(a, r, FloatMaxVectorTests::mulAll);
    }
    ...
    static void minAllFloatMaxVectorTests(IntFunction<float[]> fa) {
        ...
        assertReductionArraysEquals(a, r, FloatMaxVectorTests::minAll);
    }
    ...
    static void maxAllFloatMaxVectorTests(IntFunction<float[]> fa) {
        ...
        assertReductionArraysEquals(a, r, FloatMaxVectorTests::maxAll);
    }
    ...
    static void lessThanFloatMaxVectorTests(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatCompareOpProvider")
    static void greaterThanFloatMaxVectorTests(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatCompareOpProvider")
    static void equalFloatMaxVectorTests(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatCompareOpProvider")
    static void notEqualFloatMaxVectorTests(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatCompareOpProvider")
    static void lessThanEqFloatMaxVectorTests(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "floatCompareOpProvider")
    static void greaterThanEqFloatMaxVectorTests(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
