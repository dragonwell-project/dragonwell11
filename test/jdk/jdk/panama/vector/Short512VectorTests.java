...
public class Short512VectorTests extends AbstractVectorTest {
   ...
   static final IntFunction<short[]> fr = (vl) -> {
    ...
    @Test(dataProvider = "shortBinaryOpProvider")
    static void aShiftRShort512VectorTestsShift(IntFunction<short[]> fa, IntFunction<short[]> fb) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertShiftArraysEquals(a, b, r, Short512VectorTests::aShiftR_unary);
    }
    ...
    static void aShiftRShort512VectorTestsShift(IntFunction<short[]> fa, IntFunction<short[]> fb,
        ...
        assertShiftArraysEquals(a, b, r, mask, Short512VectorTests::aShiftR_unary);
    }
    ...
    @Test(dataProvider = "shortBinaryOpProvider")
    static void shiftRShort512VectorTestsShift(IntFunction<short[]> fa, IntFunction<short[]> fb) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertShiftArraysEquals(a, b, r, Short512VectorTests::shiftR_unary);
    }
    ...
    static void shiftRShort512VectorTestsShift(IntFunction<short[]> fa, IntFunction<short[]> fb,
        ...
        assertShiftArraysEquals(a, b, r, mask, Short512VectorTests::shiftR_unary);
    }
    ...
    @Test(dataProvider = "shortBinaryOpProvider")
    static void shiftLShort512VectorTestsShift(IntFunction<short[]> fa, IntFunction<short[]> fb) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertShiftArraysEquals(a, b, r, Short512VectorTests::shiftL_unary);
    }
    ...
    static void shiftLShort512VectorTestsShift(IntFunction<short[]> fa, IntFunction<short[]> fb,
        ...
        assertShiftArraysEquals(a, b, r, mask, Short512VectorTests::shiftL_unary);
    }
    ...
    @Test(dataProvider = "shortUnaryOpProvider")
    static void addAllShort512VectorTests(IntFunction<short[]> fa) {
        short[] a = fa.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertReductionArraysEquals(a, r, Short512VectorTests::addAll);
    }
    ...
    @Test(dataProvider = "shortUnaryOpProvider")
    static void mulAllShort512VectorTests(IntFunction<short[]> fa) {
        short[] a = fa.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertReductionArraysEquals(a, r, Short512VectorTests::mulAll);
    }
    ...
    @Test(dataProvider = "shortUnaryOpProvider")
    static void minAllShort512VectorTests(IntFunction<short[]> fa) {
        short[] a = fa.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertReductionArraysEquals(a, r, Short512VectorTests::minAll);
    }
    ...
    @Test(dataProvider = "shortUnaryOpProvider")
    static void maxAllShort512VectorTests(IntFunction<short[]> fa) {
        short[] a = fa.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertReductionArraysEquals(a, r, Short512VectorTests::maxAll);
    }
    ...
    static void anyTrueShort512VectorTests(IntFunction<boolean[]> fm) {
        ...
        assertReductionBoolArraysEquals(mask, r, Short512VectorTests::anyTrue);
    }
    ...
    static void allTrueShort512VectorTests(IntFunction<boolean[]> fm) {
        ...
        assertReductionBoolArraysEquals(mask, r, Short512VectorTests::allTrue);
    }
    ...
    @Test(dataProvider = "shortCompareOpProvider")
    static void greaterThanShort512VectorTests(IntFunction<short[]> fa, IntFunction<short[]> fb) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "shortCompareOpProvider")
    static void equalShort512VectorTests(IntFunction<short[]> fa, IntFunction<short[]> fb) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "shortCompareOpProvider")
    static void notEqualShort512VectorTests(IntFunction<short[]> fa, IntFunction<short[]> fb) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "shortCompareOpProvider")
    static void lessThanEqShort512VectorTests(IntFunction<short[]> fa, IntFunction<short[]> fb) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
    ...
    @Test(dataProvider = "shortCompareOpProvider")
    static void greaterThanEqShort512VectorTests(IntFunction<short[]> fa, IntFunction<short[]> fb) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
    ...
    static void notShort512VectorTests(IntFunction<short[]> fa) {
        ...
        assertArraysEquals(a, r, Short512VectorTests::not);
    }
