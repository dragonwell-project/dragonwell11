...
public class IntMaxVectorTests extends AbstractVectorTest {
   ...
   static final IntFunction<int[]> fr = (vl) -> {
    ...
    static void andAllIntMaxVectorTests(IntFunction<int[]> fa) {
        ...
        assertReductionArraysEquals(a, r, IntMaxVectorTests::andAll);
    }
    ...
    static void orAllIntMaxVectorTests(IntFunction<int[]> fa) {
        ...
        assertReductionArraysEquals(a, r, IntMaxVectorTests::orAll);
    }
    ...
    static void xorAllIntMaxVectorTests(IntFunction<int[]> fa) {
        ...
        assertReductionArraysEquals(a, r, IntMaxVectorTests::xorAll);
    }
    ...
    static void addAllIntMaxVectorTests(IntFunction<int[]> fa) {
        ...
        assertReductionArraysEquals(a, r, IntMaxVectorTests::addAll);
    }
    ...
    static void subAllIntMaxVectorTests(IntFunction<int[]> fa) {
        ...
        assertReductionArraysEquals(a, r, IntMaxVectorTests::subAll);
    }
    ...
    static void mulAllIntMaxVectorTests(IntFunction<int[]> fa) {
        ...
        assertReductionArraysEquals(a, r, IntMaxVectorTests::mulAll);
    }
    ...
    static void minAllIntMaxVectorTests(IntFunction<int[]> fa) {
        ...
        assertReductionArraysEquals(a, r, IntMaxVectorTests::minAll);
    }
    ...
    static void maxAllIntMaxVectorTests(IntFunction<int[]> fa) {
        ...
        assertReductionArraysEquals(a, r, IntMaxVectorTests::maxAll);
    }
