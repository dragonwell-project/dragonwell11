 ...
 *   @run testng/othervm --add-opens jdk.panama.vector/jdk.panama.vector=ALL-UNNAMED -XX:+UseVectorAPI VectorMaskFromArrayTestByte
 *
 */
public class VectorMaskFromArrayTestByte
{
    ...
    static final ByteVector.ByteSpecies Species = ByteVector.species(Shape.S_512_BIT);
    ...
    static byte[] resultd = new byte[size];
