 ...
 *   @run testng/othervm  -XX:+UseVectorAPI -Djdk.panama.vector.VECTOR_ACCESS_OOB_CHECK=0 --add-opens jdk.panama.vector/jdk.panama.vector=ALL-UNNAMED VectorTrueTestLong
 *
 */
public class VectorTrueTestLong
{

    static Random random = new Random();
    static final LongVector.LongSpecies Species = LongVector.species(Vector.Shape.S_512_BIT);
    ...
    static void vecTestSpeed(LongVector.LongSpecies Speciesint) {
        LongVector v0;
        int i = 0;
        int j = 0;
    ...
    static void vecTestCorrect(LongVector.LongSpecies Speciesint) {
        LongVector v0;
        int i = 0;
        int j = 0;
        Mask maskAny = Speciesint.maskFromArray(anyInput, i);
