 ...
 *   @run testng/othervm  -XX:+UseVectorAPI -Djdk.panama.vector.VECTOR_ACCESS_OOB_CHECK=0 --add-opens jdk.panama.vector/jdk.panama.vector=ALL-UNNAMED VectorTrueTestByte
 *
 */
public class VectorTrueTestByte
{

    static Random random = new Random();
    static final ByteVector.ByteSpecies Species = ByteVector.species(Vector.Shape.S_512_BIT);
    ...
    static void vecTestSpeed(ByteVector.ByteSpecies Speciesint) {
        ByteVector v0;
        int i = 0;
        int j = 0;
    ...
    static void vecTestCorrect(ByteVector.ByteSpecies Speciesint) {
        ByteVector v0;
        int i = 0;
        int j = 0;
        Mask maskAny = Speciesint.maskFromArray(anyInput, i);
