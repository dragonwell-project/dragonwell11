 ...
 *   @run testng/othervm --add-opens jdk.panama.vector/jdk.panama.vector=ALL-UNNAMED -XX:+UseVectorAPI VectorMaskFromArrayTestLong
 *
 */
public class VectorMaskFromArrayTestLong
{
    ...
    static final LongVector.LongSpecies Species = LongVector.species(Shape.S_512_BIT);
    ...
    static long[] resultd = new long[size];
