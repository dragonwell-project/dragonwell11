 ...
 *   @run testng/othervm --add-opens jdk.panama.vector/jdk.panama.vector=ALL-UNNAMED -XX:+UseVectorAPI TestVectorAPIMaskShort
 *
 */

public class  TestVectorAPIMaskShort
{
    ...
    static final ShortVector.ShortSpecies Species = ShortVector.preferredSpecies();
    ...
    static void vecTest128() {
        ShortVector v0;
        ShortVector.ShortSpecies Species = Species128;
        int i = 0;
        Mask mask0;
    ...
    static void vecTest256() {
        ShortVector v0;
        ShortVector.ShortSpecies Species = Species256;
        int i = 0;
        Mask mask0;
        for (i = 0; i + (Species.length()) <= size; i += Species.length()) {
            mask0 = Species.maskFromArray(AisNull, i);
    ...
    static void vecTest512() {
        ShortVector v0;
        ShortVector.ShortSpecies Species = Species512;
        int i = 0;
        Mask mask0;
        for (i = 0; i + (Species.length()) <= size; i += Species.length()) {
            mask0 = Species.maskFromArray(AisNull, i);
