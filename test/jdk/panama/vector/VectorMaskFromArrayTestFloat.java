 ...
 *   @run testng/othervm --add-opens jdk.panama.vector/jdk.panama.vector=ALL-UNNAMED -XX:+UseVectorAPI VectorMaskFromArrayTestFloat
 *
 */
public class VectorMaskFromArrayTestFloat
{
    ...
    static float[] resultd = new float[size];
