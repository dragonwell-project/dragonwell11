 ...
 *   @run testng/othervm  -XX:+UseVectorAPI -Djdk.panama.vector.VECTOR_ACCESS_OOB_CHECK=0 --add-opens jdk.panama.vector/jdk.panama.vector=ALL-UNNAMED VectorTrueTestShort
 *
 */
public class VectorTrueTestShort
{

    static Random random = new Random();
    static final ShortVector.ShortSpecies Species = ShortVector.species(Vector.Shape.S_512_BIT);
    ...
    static void vecTestSpeed(ShortVector.ShortSpecies Speciesint) {
        ShortVector v0;
        int i = 0;
        int j = 0;
    ...
    static void vecTestCorrect(ShortVector.ShortSpecies Speciesint) {
        ShortVector v0;
        int i = 0;
        int j = 0;
        Mask maskAny = Speciesint.maskFromArray(anyInput, i);
