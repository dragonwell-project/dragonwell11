 ...
 *   @run testng/othervm  -XX:+UseVectorAPI -Djdk.panama.vector.VECTOR_ACCESS_OOB_CHECK=0 --add-opens jdk.panama.vector/jdk.panama.vector=ALL-UNNAMED VectorTrueTestFloat
 *
 */
public class VectorTrueTestFloat
{

    static Random random = new Random();
    static final FloatVector.FloatSpecies Species = FloatVector.species(Vector.Shape.S_512_BIT);
    ...
    static void vecTestSpeed(FloatVector.FloatSpecies Speciesint) {
        FloatVector v0;
        int i = 0;
        int j = 0;
    ...
    static void vecTestCorrect(FloatVector.FloatSpecies Speciesint) {
        FloatVector v0;
        int i = 0;
        int j = 0;
        Mask maskAny = Speciesint.maskFromArray(anyInput, i);
